...
function Controller() {
  var self = this;
  self.main = document.getElementById("screen");
  self.main.width = screenWidth;
  self.main.height = screenHeight;
  self.ctx = self.main.getContext("2d");
  ...
  self.draw = function () {
    ...
    self.ctx.fillRect(0, 0, self.main.width, self.main.height);
